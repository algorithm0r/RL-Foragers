...
var PARAMETERS = {
  ...
  ecoShelters: 16,        // central place: how many shelters to place at fixed precoded spots (ECO_SHELTER_SPOTS,
                          //   ordered for spread). Energy is gained ONLY by resting here; more = easier to find one.
...
var ECO_SCHEMA = [
  ...
  { key: 'ecoShelters', label: 'Shelters', min: 1, max: 21, step: 1, resets: true },
